...
rp_setup
got=$(rp_facts)
[ "$got" = "2222,7500-7532,9100" ] && ok || fail "база по умолчанию: ожидалось 2222,7500-7532,9100, получено '$got'"

got=$(rp_facts env MON_FACT_NODE_API_PORT=20000)
[ "$got" = "2222,7500-7532,20000" ] && ok || fail "кастомный NODE_API_PORT: ожидалось 2222,7500-7532,20000, получено '$got'"
...
got=$(rp_facts)
[ "$got" = "2222,7500-7532,30000" ] && ok || fail "порт из .env ноды: ожидалось 2222,7500-7532,30000, получено '$got'"
...
got=$(rp_facts)
[ "$got" = "2222-2223,5201,7500-7532,8443-8451,9100" ] && ok \
    || fail "канонизация extras: ожидалось 2222-2223,5201,7500-7532,8443-8451,9100, получено '$got'"
...
grep -q '^net.ipv4.ip_local_reserved_ports = 2222,7500-7532,9100$' "$rp_file" && ok \
