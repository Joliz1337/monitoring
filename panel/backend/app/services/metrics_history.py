...
PER_CPU_BUCKET: dict[str, int] = {"1h": 30, "24h": 300}
# Выше этого числа ядер бакет тепловой карты вдвое шире — иначе матрица
# 64×2880 ячеек в ответе весит больше самой страницы.
MANY_CORES = 32
