      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <FAQIcon screen="PAGE_SERVER_DETAILS" />
          </div>
          {metrics && (
            <motion.p 
        ...
        >
          ...
          {/* Speed test dropdown */}
          <Tooltip label={t('server_card.speedtest_run')}>
            <motion.button
          ...
          <motion.div key="content" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            >
              <MetricCard
                ...
                className={metrics.cpu.per_cpu_percent && metrics.cpu.per_cpu_percent.length > 8 ? 'col-span-2' : ''}
                delay={0}
              />
            ...
            >
              ...
              <ChartCard
                ...
                title={t('server_details.load_average')}
                isLoading={isHistoryLoading}
              >
                <MetricChart
                  data={loadAvgHistory}
...
function MetricCard({ icon, label, value, subtext, delay, showCores, perCpuPercent, className = '' }: MetricCardProps) {
  return (
    <motion.div
