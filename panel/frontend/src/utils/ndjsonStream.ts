...
/**
 * Читает NDJSON-поток ответа на GET. Используется для подписки на лог фоновых
 * задач (установка Remnawave/WARP, доставка образа, Xray-тест) — поток
 * переподключаемый и не привязан к телу запроса.
 */
