...
**Подача результатов — дерево, а не плоский список.** Верхний уровень — сервер (`адрес:порт`) со сводкой: лучший TCP, лучшая задержка, сколько проверок из скольких прошло, общий вердикт (лучшее из того, что внутри: один рабочий SNI делает сервер пригодным). Раскрытие даёт места запуска — но только если их больше одного, иначе уровень пропускается и сразу видны проверки. Ниже строка на проверку (SNI), её раскрытие — причина, подсказка, вывод ядра, сертификат. На подписке в сотню серверов плоский список был нечитаем: одна строка на каждую комбинацию давала тысячи строк подряд.
