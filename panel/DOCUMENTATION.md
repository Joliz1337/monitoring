...
- `panel/frontend/src/components/Traffic/EphemeralPorts.tsx`, типы `EphemeralPorts`/`EphemeralSource`/`EphemeralDestination` в `api/client.ts`, `data/faq/content/{ru,en}/TRAFFIC_EPHEMERAL_PORTS.md`, ключи `ephemeral.*` в `locales/{ru,en}.json`
