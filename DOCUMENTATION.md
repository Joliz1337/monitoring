...
Многослойная защита от DDoS-атак на нодах (`WATCHDOG_VERSION` 2.2.0), независимая от системного sysctl-тюнинга выше — conntrack-хардening из общего профиля остаётся первой линией обороны. Три слоя:
...
- [panel/DOCUMENTATION.md](panel/DOCUMENTATION.md) — веб-панель: API, БД, конфигурация, безопасность (v10.66.0)
