...
├── .github/
│   └── screenshots/   # PNG-скриншоты 9 модулей панели для README/README.en (сами PNG пользователь добавляет вручную; README.md в папке — чек-лист нужных кадров и рекомендации по съёмке)
