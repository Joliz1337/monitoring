...
**Системный тюнинг — универсальный рендерер (`configs/tune-sysctl.sh`, `configs/VERSION` 5.1.0):**
...
Многослойная защита от DDoS-атак на нодах (`WATCHDOG_VERSION` 2.0.0), независимая от системного sysctl-тюнинга выше — conntrack-хардening из общего профиля остаётся первой линией обороны. Три слоя:
